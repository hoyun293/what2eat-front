...
export const createBranchUniversalObject = (voteUrl: string, title: string) => {
  const properties = {
  ...
  return BranchIo.createBranchUniversalObject(properties)
}

export const shareLink = (voteUrl: string, title: string) => {
  createBranchUniversalObject(voteUrl, title)
